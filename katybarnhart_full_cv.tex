...
\begin{itemize}
	...
	\item Reviewer for JGR-Earth Surface, Geomorphology, Natural Hazards,  Earth Surface Processes and Landforms, Journal of Open Source Software, Journal of Flood Risk Management, Proceedings of the National Academy of Sciences
...
\begin{tabular}{{>{\raggedright\arraybackslash}p{1in}%
	...
	Inundation Modeling: & FLO2D, RAMMS, D-CLAW\\
	Software:  &  \LaTeX, Matlab, GRASS GIS, QGIS, ArcGIS, Dakota Uncertainty Quantification, Agisoft Photoscan, Cloud Compare, Affinity, Adobe Creative Suite (Illustrator, Photoshop, Premiere, AfterEffects) \\
\end{tabular}
\endgroup
\end{document}
%-------------------------------------------------------%