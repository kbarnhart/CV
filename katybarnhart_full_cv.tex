...
\begin{outerlist}
	\item[] Jessica Ghent, Front Range Community College \\
				  June 2018--present\\
				  \textit{The impact of ground control points on Structure from Motion scene uncertainty}\\
				  As part of the Research Experience for Community College Students program, Jess analyzed the impact of ground control point placement at the Chalk Cliffs debris flow site. She has continued this work as a temporary employee at the University of Colorado. She presented her project at the American Geophysical Union Fall meeting in December 2018. Has been accepted to the University of Colorado Honors Program to matriculate in Fall 2019.
			  \end{outerlist}
...
\begin{outerlist}
	...
	\begin{innerlist}
		\item Model sensitivity analysis and optimization with Dakota and Landlab (CSDMS 2017, 2018)
