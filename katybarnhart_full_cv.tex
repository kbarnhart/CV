...
\makeheading{\hspace{-15pt} {\Large Katherine Barnhart} {\small (she/her)}}
...
TODO I develop and apply numerical models to understand the physical processes which shape Earth’s surface, specifically those processes which impact erosion and sedimentation hazards. I use model intercomparison, parameter estimation, and scenario design to determine the relative contributions of different uncertainty sources (for example, model physics representation, boundary conditions, site specific characteristics). 
...
\textit{See \hyperref[detailedexp]{Detailed Professional Experience} below for specific duties and accomplishments}
\begin{outerlist}
...
\subsection{Training}
TODO
University of Colorado UAS Ground School
Tom Noble Photogrammetry
