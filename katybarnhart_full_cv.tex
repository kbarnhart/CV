...
\makeheading{Katherine Barnhart\\ {\small (she/her/hers)}}
...
Boulder, Colorado 
\begin{outerlist}
\item[] Ph.D., Geological Sciences, August 2015
        \begin{innerlist}
        \item Advisor:
              \href{http://instaar.colorado.edu/~andersrs/}
                   {Robert S.~Anderson}
        \end{innerlist}      
        \item[] M.S., Geological Sciences, May 2010
        \begin{innerlist}
        \item Advisor:
...
Princeton, NJ
\begin{outerlist}
\item[] B.S.E., Civil and Environmental Engineering (Honors), May 2008
        \begin{innerlist}
...
\href{https://www.usgs.gov}{\textbf{U.S. Geological Survey}},
Golden, Colorado
\begin{outerlist}
	\item[] Research Civil Engineer April 2020--present
	\begin{innerlist}
	\item Landslide Hazards Program, post-fire debris flow group
	\item Supervisor: \href{https://www.usgs.gov/staff-profiles/jason-kean}{Jason Kean}\\
	\end{innerlist}
\end{outerlist}

\href{https://www.arizona.edu/}{\textbf{University of Arizona}},
 Tucson, Arizona  
\begin{outerlist}
	\item[] Department of Geosciences Designated Campus Colleague, March 2020--present\\
\end{outerlist}
...
\begin{outerlist}
	\item David Litwin, Johns Hopkins University XXXXX TODO
